/*
Проект в котором я ближе познакомился с комплексной анимацией в таймлайне,
нескольких элементов одновременно. Важно, что новый твин добавляется в конец таймлайна,
а не к последнему твину. Для того чтобы добавить новый твин к последнему твину (соседу),
мы используем ">"
*/
